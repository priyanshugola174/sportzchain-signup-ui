export const environment = {
  ...
  api: {
    profileService: "https://api.sportzchain.com/signup/v1/getprofile",
    claimBonus: "https://api.sportzchain.com/signup/v1/submitclaim",
    rewardHistory: "https://api.sportzchain.com/signup/v1/getrewardhistory",
    updateProfile: "https://api.sportzchain.com/signup/v1/updateprofile",
  },
  launchdate: {
